...
@NoArgsConstructor
@Schema(
        description = "Returned data after authenticate a user"
)
public class AuthenticationInformationDto implements Serializable {
    ...
    @Schema(
            description = "Unique identifier of every authentication information instance. Usually a UUID autogenerated value",
    ...
    @Schema(
            description = "Token-based authentication to allow an application to access the microservices",
            requiredMode = RequiredMode.REQUIRED
    )
