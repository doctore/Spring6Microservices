package com.invoice.grpc.interceptor;
...
public class RequestIdInterceptor implements ClientInterceptor {
    ...
    /**
     *    Adds the header {@link GrpcHeader#REQUEST_ID} to the existing ones. It will be used as a unique identifier of
     * the current request across all invoked microservices.
     *
     * @param headers
     *    {@link Metadata} with the data to send to gRPC server
     */
    private void addRequestIdHeader(final Metadata headers) {
        headers.put(
