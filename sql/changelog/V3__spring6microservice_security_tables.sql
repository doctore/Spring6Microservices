...
CREATE INDEX IF NOT EXISTS spring6microservice_user_role_user_id_index ON security.spring6microservice_user_role (user_id);
...
CREATE INDEX IF NOT EXISTS spring6microservice_role_permission_role_id_index ON security.spring6microservice_role_permission (role_id);