...
public class ValidationTest {
    ...
    static Stream<Arguments> filterTestCases() {
        ...
        return Stream.of(
                ...
                Arguments.of( validVerifyFilter,          IS_INTEGER_ODD,   of(validVerifyFilter) ),
                Arguments.of( validDoesNotVerifyFilter,   IS_INTEGER_ODD,   empty() ),
                Arguments.of( invalid,                    null,             of(invalid) ),
                Arguments.of( invalid,                    IS_INTEGER_ODD,   of(invalid) )
        ); //@formatter:on
    }
    ...
    static Stream<Arguments> filterOrElseTestCases() {
        ...
        return Stream.of(
                ...
                Arguments.of( validVerifyFilter,          IS_INTEGER_ODD,   null,          null,                             validVerifyFilter ),
                Arguments.of( validVerifyFilter,          IS_INTEGER_ODD,   errorString,   null,                             validVerifyFilter ),
                Arguments.of( validDoesNotVerifyFilter,   IS_INTEGER_ODD,   null,          IllegalArgumentException.class,   null ),
                Arguments.of( validDoesNotVerifyFilter,   IS_INTEGER_ODD,   errorString,   null,                             invalidResult ),
                Arguments.of( invalid,                    IS_INTEGER_ODD,   errorString,   null,                             invalid )
        ); //@formatter:on
    }
    ...
    static Stream<Arguments> mapWithValidMapperTestCases() {
        ...
        return Stream.of(
                ...
                Arguments.of( valid,        FROM_INTEGER_TO_STRING,   null,                             Validation.valid("1") ),
                Arguments.of( invalid,      null,                     null,                             invalid ),
                Arguments.of( invalid,      FROM_INTEGER_TO_STRING,   null,                             invalid )
        ); //@formatter:on
    }
    ...
    static Stream<Arguments> mapWithBothMappersTestCases() {
        ...
        return Stream.of(
                ...
                Arguments.of( valid,        null,            FROM_INTEGER_TO_STRING,   null,                             Validation.valid("1") ),
                Arguments.of( valid,        addALetter,      FROM_INTEGER_TO_STRING,   null,                             Validation.valid("1") ),
                Arguments.of( invalid,      null,            FROM_INTEGER_TO_STRING,   IllegalArgumentException.class,   null ),
                Arguments.of( invalid,      addALetter,      null,                     null,                             Validation.invalid(List.of("problem2")) ),
                Arguments.of( invalid,      addALetter,      FROM_INTEGER_TO_STRING,   null,                             Validation.invalid(List.of("problem2")) )
        ); //@formatter:on
    }
    ...
    static Stream<Arguments> foldTwoMappersTestCases() {
        ...
        return Stream.of(
                ...
                Arguments.of( invalid,      null,              FROM_INTEGER_TO_STRING,   IllegalArgumentException.class,   null ),
                Arguments.of( valid,        null,              FROM_INTEGER_TO_STRING,   null,                             "1" ),
                Arguments.of( valid,        collectionSize,    FROM_INTEGER_TO_STRING,   null,                             "1" ),
                Arguments.of( invalid,      collectionSize,    null,                     null,                             2 ),
                Arguments.of( invalid,      collectionSize,    FROM_INTEGER_TO_STRING,   null,                             2 )
        ); //@formatter:on
    }
    ...
    public <E, T> void peekWithBothConsumers_testCases(Validation<E, T> validation,
        ...
        assertEquals(
                expectedResult,
                validation.peek(actionInvalid, actionValid)
        );
    }
