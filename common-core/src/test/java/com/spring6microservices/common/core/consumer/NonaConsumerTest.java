...
public class NonaConsumerTest {
    ...
    public void accept_thenTheDefinedOperationIsPerformedBasedOnProvidedArguments() {
        ...
        NonaConsumer<Integer, String, Boolean, Integer, String, Boolean, Integer, String, Boolean> plusNAndAddSAndChangeB = (i1, s1, b1, i2, s2, b2, i3, s3, b3) -> {
        ...
        assertEquals("a1b2_3", list.get(7));
    ...
    public void andThen_whenAfterIsNotNull_thenAfterIsAppliedAfterCurrentConsumer() {
        ...
        assertEquals("a1b2_3_3", list.get(7));
        assertEquals(false, list.get(8));
    }
