...
import static com.spring6microservices.common.core.collection.tuple.Tuple0.comparator;
import static com.spring6microservices.common.core.collection.tuple.Tuple0.instance;
...
public class Tuple0Test {
    ...
    static Stream<Arguments> concatTuple8TestCases() {
        Tuple8<String, Integer, Integer, Integer, Boolean, Long, Short, Character> t1 = Tuple8.of("TYHG", 534, 999, 1, TRUE, 11L, (short)69, 'c');
        Tuple8<Long, Integer, Boolean, Boolean, String, Float, Integer, String> t2 = Tuple8.of(21L, 677, FALSE, TRUE, "POL", 45.3f, 14, "12");
        return Stream.of(
                //@formatter:off
                //            tuple,   expectedResult
                Arguments.of( null,    Tuple8.empty() ),
                Arguments.of( t1,      t1 ),
                Arguments.of( t2,      t2 )
        ); //@formatter:on
    }
    ...
    public <T1, T2, T3, T4, T5, T6, T7, T8> void concatTuple8_testCases(Tuple8<T1, T2, T3, T4, T5, T6, T7, T8> tuple,
    ...
    static Stream<Arguments> concatTuple9TestCases() {
        Tuple9<String, Integer, Integer, Integer, Boolean, Long, Short, Character, Long> t1 = Tuple9.of("TYHG", 534, 999, 1, TRUE, 11L, (short)69, 'c', 19L);
        Tuple9<Long, Integer, Boolean, Boolean, String, Float, Integer, String, Integer> t2 = Tuple9.of(21L, 677, FALSE, TRUE, "POL", 45.3f, 14, "12", 33);
        return Stream.of(
                //@formatter:off
                //            tuple,   expectedResult
                Arguments.of( null,    Tuple9.empty() ),
                Arguments.of( t1,      t1 ),
                Arguments.of( t2,      t2 )
        ); //@formatter:on
    }
    ...
    @ParameterizedTest
    @MethodSource("concatTuple9TestCases")
    @DisplayName("concat: using Tuple9 test cases")
    public <T1, T2, T3, T4, T5, T6, T7, T8, T9> void concatTuple9_testCases(Tuple9<T1, T2, T3, T4, T5, T6, T7, T8, T9> tuple,
