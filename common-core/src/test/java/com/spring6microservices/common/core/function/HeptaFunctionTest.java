...
public class HeptaFunctionTest {
    ...
    static Stream<Arguments> applyTestCases() {
        return Stream.of(
                ...
                Arguments.of( 0,     5,      4,     3,       9,    -1,     11,       SUM_ALL_INTEGERS,                      31 ),
                Arguments.of( "A",   "Bb",   "C",   "FFF",   "",   "h",    "12Yu",   SUM_ALL_STRING_LENGTH,                 12 ),
                Arguments.of( 3,     "x",    7,     "RT",    2,    "yC",   4,        MULTIPLY_INTEGER_AND_STRING_LENGTH,   672L )
        ); //@formatter:on
    }
    ...
    static Stream<Arguments> andThenTestCases() {
        ...
        return Stream.of(
                ...
                Arguments.of( 3,       3,      3,      3,      3,      -1,      9,        SUM_ALL_INTEGERS,        null,            NullPointerException.class,   null ),
                Arguments.of( 2,       5,      1,      4,      7,      3,       -1,       SUM_ALL_INTEGERS,        multiply2,       null,                         42 ),
                Arguments.of( "A",     "Bb",   "C",    "TT",   "",     "TYH",   "12TI",   SUM_ALL_STRING_LENGTH,   multiply2,       null,                         26 ),
    ...
    private static final HeptaFunction<String, String, String, String, String, String, String, String> JOIN_ALL_STRINGS =
            (t1, t2, t3, t4, t5, t6, t7) -> t1 + t2 + t3 + t4 + t5 + t6 + t7;

    private static final HeptaFunction<Integer, String, Integer, String, Integer, String, Integer, Long> MULTIPLY_INTEGER_AND_STRING_LENGTH =
            (t1, t2, t3, t4, t5, t6, t7) -> (long) t1 * t2.length() * t3 * t4.length() * t5 * t6.length() * t7;

    private static final HeptaFunction<Integer, Integer, Integer, Integer, Integer, Integer, Integer, Integer> SUM_ALL_INTEGERS =
            (t1, t2, t3, t4, t5, t6, t7) -> t1 + t2 + t3 + t4 + t5 + t6 + t7;

    private static final HeptaFunction<String, String, String, String, String, String, String, Integer> SUM_ALL_STRING_LENGTH =
