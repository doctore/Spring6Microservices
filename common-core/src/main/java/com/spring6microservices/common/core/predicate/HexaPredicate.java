...
public interface HexaPredicate<T1, T2, T3, T4, T5, T6> {
     ...
     */
    default HexaPredicate<T1, T2, T3, T4, T5, T6> and(final HexaPredicate<? super T1, ? super T2, ? super T3, ? super T4, ? super T5, ? super T6> other) {
     ...
     * @throws NullPointerException if {@code other} is {@code null}
     */
    default HexaPredicate<T1, T2, T3, T4, T5, T6> or(final HexaPredicate<? super T1, ? super T2, ? super T3, ? super T4, ? super T5, ? super T6> other) {
        requireNonNull(other);
        return (t1, t2, t3, t4, t5, t6) ->
                this.test(t1, t2, t3, t4, t5, t6) ||
                        other.test(t1, t2, t3, t4, t5, t6);
