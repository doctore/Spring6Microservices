...
public interface PentaPredicate<T1, T2, T3, T4, T5> {
     ...
     */
    default PentaPredicate<T1, T2, T3, T4, T5> and(final PentaPredicate<? super T1, ? super T2, ? super T3, ? super T4, ? super T5> other) {
     ...
     * @throws NullPointerException if {@code other} is {@code null}
     */
    default PentaPredicate<T1, T2, T3, T4, T5> or(final PentaPredicate<? super T1, ? super T2, ? super T3, ? super T4, ? super T5> other) {
        requireNonNull(other);
        return (t1, t2, t3, t4, t5) ->
                this.test(t1, t2, t3, t4, t5) ||
                        other.test(t1, t2, t3, t4, t5);
