...
public abstract class Try<T> implements Serializable {
    ...
    /**
     * Creates a {@link Success} invoking the provided {@link TetraFunction} with given input parameters.
     *
     * @param t1
     *    First input parameter used by given {@link TetraFunction}
     * @param t2
     *    Second input parameter used by given {@link TetraFunction}
     * @param t3
     *    Third input parameter used by given {@link TetraFunction}
     * @param t4
     *    Fourth input parameter used by given {@link TetraFunction}
     * @param function
     *    {@link TetraFunction} used to get the value to store in the returned {@link Success}
     *
     * @return {@link Success} if invoking the {@link TetraFunction} no {@link Throwable} was thrown,
     *         {@link Failure} otherwise.
     */
    public static <T1, T2, T3, T4, R> Try<R> of(final T1 t1,
                                                ...
                                                final T3 t3,
                                                final T4 t4,
                                                final TetraFunction<T1, T2, T3, T4, R> function) {
        try {
            return success(
    ...
    /**
     * Creates a {@link Success} invoking the provided {@link OctaFunction} with given input parameters.
     *
     * @param t1
     *    First input parameter used by given {@link OctaFunction}
     * @param t2
     *    Second input parameter used by given {@link OctaFunction}
     * @param t3
     *    Third input parameter used by given {@link OctaFunction}
     * @param t4
     *    Fourth input parameter used by given {@link OctaFunction}
     * @param t5
     *    Fifth input parameter used by given {@link OctaFunction}
     * @param t6
     *    Sixth input parameter used by given {@link OctaFunction}
     * @param t7
     *    Seventh input parameter used by given {@link OctaFunction}
     * @param t8
     *    Eighth input parameter used by given {@link OctaFunction}
     *
     * @param function
     *    {@link OctaFunction} used to get the value to store in the returned {@link Success}
     *
     * @return {@link Success} if invoking the {@link OctaFunction} no {@link Throwable} was thrown,
     *         {@link Failure} otherwise.
     */
    public static <T1, T2, T3, T4, T5, T6, T7, T8, R> Try<R> of(final T1 t1,
                                                                final T2 t2,
                                                                final T3 t3,
                                                                final T4 t4,
                                                                final T5 t5,
                                                                ...
                                                                final T7 t7,
                                                                final T8 t8,
                                                                final OctaFunction<T1, T2, T3, T4, T5, T6, T7, T8, R> function) {
        try {
            return success(
    ...
    /**
     * Creates a {@link Success} invoking the provided {@link NonaFunction} with given input parameters.
     *
     * @param t1
     *    First input parameter used by given {@link NonaFunction}
     * @param t2
     *    Second input parameter used by given {@link NonaFunction}
     * @param t3
     *    Third input parameter used by given {@link NonaFunction}
     * @param t4
     *    Fourth input parameter used by given {@link NonaFunction}
     * @param t5
     *    Fifth input parameter used by given {@link NonaFunction}
     * @param t6
     *    Sixth input parameter used by given {@link NonaFunction}
     * @param t7
     *    Seventh input parameter used by given {@link NonaFunction}
     * @param t8
     *    Eighth input parameter used by given {@link NonaFunction}
     * @param t9
     *    Ninth input parameter used by given {@link NonaFunction}
     *
     * @param function
     *    {@link NonaFunction} used to get the value to store in the returned {@link Success}
     *
     * @return {@link Success} if invoking the {@link NonaFunction} no {@link Throwable} was thrown,
     *         {@link Failure} otherwise.
     */
    public static <T1, T2, T3, T4, T5, T6, T7, T8, T9, R> Try<R> of(final T1 t1,
                                                                    final T2 t2,
                                                                    final T3 t3,
                                                                    final T4 t4,
                                                                    final T5 t5,
                                                                    ...
                                                                    final T8 t8,
                                                                    final T9 t9,
                                                                    final NonaFunction<T1, T2, T3, T4, T5, T6, T7, T8, T9, R> function) {
        try {
            return success(
    ...
    public final Try<T> peek(final Consumer<? super Throwable> actionFailure,
        ...
        if (isSuccess() && null != actionSuccess) {
            actionSuccess.accept(get());
        }
        if (!isSuccess() && null != actionFailure) {
