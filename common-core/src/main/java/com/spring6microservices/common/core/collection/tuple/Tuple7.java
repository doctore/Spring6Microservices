...
public class Tuple7<T1, T2, T3, T4, T5, T6, T7> implements Tuple, Serializable {
    ...
    /**
     * Maps the elements of this {@link Tuple7} using a mapper function.
     *
     * @param mapper
    ...
    /**
     * Maps the elements of this {@link Tuple7} using a mapper function for each element.
     *
     * @param f1
     ...
     * @return A new {@link Tuple7} of same arity.
     *
     * @throws NullPointerException if {@code f1}, {@code f2}, {@code f3}, {@code f4}, {@code f5}, {@code f6} or {@code f7}
     *                              are {@code null}
     */
    ...
    /**
     * Prepend a value to this {@link Tuple7}.
     *
     * @param t
     *    The value to prepend
     *
     * @return a new {@link Tuple8} with the value prepended
     */
    public <T> Tuple8<T, T1, T2, T3, T4, T5, T6, T7> prepend(final T t) {
        return Tuple.of(t, _1, _2, _3, _4, _5, _6, _7);
    }


    /**
     * Append a value to this {@link Tuple7}.
     *
     * @param t
     *    The value to append
     *
     * @return a new {@link Tuple8} with the value appended
     */
    public <T> Tuple8<T1, T2, T3, T4, T5, T6, T7, T> append(final T t) {
        return Tuple.of(_1, _2, _3, _4, _5, _6, _7, t);
    }


    /**
     * Concat a {@link Tuple1}'s values to this {@link Tuple7}.
     *
     * @param tuple
     ...
     */
    public <T8> Tuple8<T1, T2, T3, T4, T5, T6, T7, T8> concat(final Tuple1<T8> tuple) {
        return ofNullable(tuple)
                .map(t ->
                        Tuple.of(_1, _2, _3, _4, _5, _6, _7, t._1)
                )
                .orElseGet(() ->
                        Tuple.of(_1, _2, _3, _4, _5, _6, _7, null)
                );
    }


    /**
     * Concat a {@link Tuple2}'s values to this {@link Tuple7}.
     *
     * @param tuple
     ...
     */
    public <T8, T9> Tuple9<T1, T2, T3, T4, T5, T6, T7, T8, T9> concat(final Tuple2<T8, T9> tuple) {
        return ofNullable(tuple)
                .map(t ->
                        Tuple.of(_1, _2, _3, _4, _5, _6, _7, t._1, t._2)
                )
                .orElseGet(() ->
                        Tuple.of(_1, _2, _3, _4, _5, _6, _7, null, null)
                );
    }
